    ...
    <section className="relative py-24 pt-40 flex flex-col justify-center items-center text-white text-center px-6 md:px-12 lg:px-20 bg-transparent to-red-500">
      ...
      >
        ...
        <p className="text-lg md:text-2xl text-gray-100 mt-6 leading-relaxed">
          Get instant engagement with real Followers. Build credibility and grow your profile effortlessly!
        </p>
        
        <GlowingButton>
          Buy Followers Now <FaArrowRight />
        </GlowingButton>
      </motion.div>
    </section>
  );
...
const FollowersServicesSection = () => {
  return (
    <>
      <HerosSection />
    </>
...
export default FollowersServicesSection;
