...
const FollowersFAQSection = () => {
  const [openIndex, setOpenIndex] = useState(null);

  const faqs = [
    {
      question: "How does buying followers work?",
      answer:
        "Simply select a package, complete the payment, and watch your follower count grow within minutes! We ensure safe and efficient delivery to boost your social presence.",
    },
    {
      question: "Are these followers from real accounts?",
      answer:
        "Yes! Our followers come from high-quality, active accounts to maintain the authenticity of your profile.",
    },
    {
    ...
    {
      question: "What if I don’t receive my followers?",
      answer:
    ...
    <section className="text-white py-14 px-6 lg:px-16 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-gray-400 text-lg">
          Everything you need to know about buying followers.
        </p>
      </div>
...
export default FollowersFAQSection;
