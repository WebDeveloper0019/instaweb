...
import TelegramVerificationImage from "/assets/telegram.svg"; // Ensure correct path
    ...
    <section className="relative text-white py-40 px-6 lg:px-24 flex flex-col lg:flex-row items-center justify-between overflow-hidden">
      <div className="max-w-lg text-center lg:text-left animate-fadeIn">
        ...
        <p className="mt-5 text-lg text-gray-400 leading-relaxed">
          Boost your credibility with <strong>Telegram Group, Bot, and Channel Verification</strong>. 
          Our expert team assists you in <strong>applying and securing</strong> verification quickly and efficiently.
        </p>

        <div className="mt-8 flex flex-col sm:flex-row sm:space-x-4 items-center">
          <Link
            to="/telegram-verification"
      ...
      <div className="relative mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
        <img
          src={TelegramVerificationImage}
          alt="Telegram Verification Services"
