...
import TwitterGoldBadgeImage from "/assets/twitter.svg"; // Ensure correct path
    ...
    <section className="relative text-white py-40 px-6 lg:px-24 flex flex-col lg:flex-row items-center justify-between overflow-hidden">
      <div className="max-w-lg text-center lg:text-left animate-fadeIn">
        <h1 className="text-5xl lg:text-7xl font-extrabold leading-tight text-white drop-shadow-lg">
          Get Twitter Gold Badge
        </h1>
        <p className="mt-5 text-lg text-gray-400 leading-relaxed">
          Elevate your brand's credibility with the <strong>Twitter Gold Verification Badge</strong>. 
          Our expert team assists you in <strong>applying and securing</strong> your Gold Badge quickly and efficiently.
        </p>

        <div className="mt-8 flex flex-col sm:flex-row sm:space-x-4 items-center">
          <Link
            to="/twitter-gold-badge"
      ...
      <div className="relative mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
        <img
          src={TwitterGoldBadgeImage}
          alt="Twitter Gold Badge Verification Services"
