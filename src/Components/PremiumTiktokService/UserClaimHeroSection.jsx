...
import { FaCheckCircle, FaUserTag, FaUsers } from "react-icons/fa";
...
const UsernameClaimHeroSection = () => {
  return (
    <section className="relative text-white pt-40 px-6 lg:px-24 flex flex-col lg:flex-row items-center justify-between overflow-hidden">
      <div className="max-w-lg text-center lg:text-left animate-fadeIn">
        ...
        <p className="mt-5 text-lg text-gray-400 leading-relaxed">
          Want a <strong>premium or inactive TikTok username</strong>? Our team 
          helps you <strong>secure your desired username</strong> through a hassle-free 
          and legitimate claim process. Stand out with the perfect username today!
        </p>

        <div className="mt-8 flex flex-col sm:flex-row sm:space-x-4 items-center">
          <Link
            to="/tiktok-username-claim"
...
export default UsernameClaimHeroSection;
