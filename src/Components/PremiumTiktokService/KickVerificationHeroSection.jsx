...
import KickImage from "/assets/live.png"; // Ensure correct path
...
const KickVerificationHeroSection = () => {
  return (
    <section className="relative text-white pt-40 px-6 lg:px-24 flex flex-col lg:flex-row items-center justify-between overflow-hidden">
      <div className="max-w-lg text-center lg:text-left animate-fadeIn">
        <h1 className="text-5xl lg:text-7xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 drop-shadow-lg">
          Get Verified on Kick Channel
        </h1>
        <p className="mt-5 text-lg text-gray-400 leading-relaxed">
          Secure your <strong>verified badge</strong> on Kick and establish credibility. 
        ...
        <div className="mt-8 flex flex-col sm:flex-row sm:space-x-4 items-center">
          <Link
            to="/kick-verification"
            className="bg-gradient-to-r from-green-500 to-blue-600 text-white font-bold py-4 px-8 rounded-lg shadow-lg hover:scale-105 transition transform duration-300"
          >
      ...
      <div className="relative mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
        <img
          src={KickImage}
          alt="Kick Verification Services"
...
export default KickVerificationHeroSection;