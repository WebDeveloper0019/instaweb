...
const HeroSection = () => {
  return (
    <section className="relative  text-white hero_section_padding  pt-42 px-6 lg:px-24 flex flex-col lg:flex-row items-center justify-between overflow-hidden">
  ...
  <strong>Trusted by 100,000+ users</strong>, we help you grow effortlessly.
      ...
      <div className="relative mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
        ...
        <motion.div
          className={`absolute state_icons top-8 left-12  bg-gradient-to-r from-red-500 to-pink-500 ${floatingButtonStyle}`}
        ...
        <motion.div
          className={`absolute state_icons1 top-1/2 right-12 bg-gradient-to-r from-blue-500 to-cyan-400 ${floatingButtonStyle}`}
          variants={floatingVariants}
          animate="animate"
        >
          <FaEye size={24} />
        ...
        <motion.div
          className={`absolute bottom-0 state_icons2 left-0 bg-gradient-to-r from-green-500 to-teal-400 ${floatingButtonStyle}`}
          variants={floatingVariants}
          animate="animate"
        >
          <FaUserPlus size={24} />
