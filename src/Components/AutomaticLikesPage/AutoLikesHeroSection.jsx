    ...
    <section className="relative text-white pt-48 px-6 lg:px-24 flex flex-col lg:flex-row items-center justify-between overflow-hidden">
      ...
      <div className="max-w-lg text-center lg:text-left animate-fadeIn">
        <h1 className="text-5xl lg:text-7xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 drop-shadow-lg">
          Get Automatic Likes Instantly
        </h1>
        <p className="mt-5 text-lg text-gray-400 leading-relaxed">
          Enhance your engagement effortlessly with our <strong>automatic likes system</strong>. 
          Receive real, organic-looking likes <strong>instantly on your posts</strong>. 
      ...
      <div className="relative mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
        ...
        <motion.div
          className={`absolute top-4 left-12 bg-gradient-to-r from-red-500 to-pink-500 ${floatingButtonStyle}`}
        ...
        <motion.div
          className={`absolute top-1/2 right-0 bg-gradient-to-r from-blue-500 to-cyan-400 ${floatingButtonStyle}`}
          variants={floatingVariants}
          animate="animate"
        >
          <FaEye size={24} />
...
export default AutoLikesHeroSection;
