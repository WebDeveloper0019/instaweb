...
const AutoLikesFAQSection = () => {
  const [openIndex, setOpenIndex] = useState(null);

  const faqs = [
    {
      question: "How does buying views work?",
      answer:
        "Simply select a package, complete the payment, and watch your views increase within minutes! We ensure safe and efficient delivery to boost your engagement.",
    },
    {
      question: "Are these views from real accounts?",
      answer:
        "Yes! Our views come from high-quality, active accounts to maintain the authenticity of your social media presence.",
    },
    {
      question: "How long does it take to receive the views?",
      answer:
        "Delivery starts within minutes after purchase, and depending on the package size, it may take a few hours to complete.",
    },
    {
      question: "Is buying views safe?",
      answer:
        "Absolutely! Our methods comply with platform guidelines, ensuring no risk to your account. We never ask for your password.",
    },
    {
      question: "What if I don’t receive my views?",
      answer:
    ...
    <section className="text-white py-14 px-6 lg:px-16 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-gray-400 text-lg">
          Everything you need to know about buying views.
        </p>
      </div>
...
export default AutoLikesFAQSection;
