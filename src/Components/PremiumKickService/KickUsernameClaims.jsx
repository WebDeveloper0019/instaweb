  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-transparent p-6">
      <div className="max-w-3xl w-full bg-white shadow-lg rounded-lg p-8 text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Kick Username Claims</h1>
        <p className="text-gray-600 mb-6">
          Secure your desired Kick username with our professional assistance. Whether you need to claim an inactive handle
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="flex flex-col items-center bg-gray-50 p-4 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-500 text-center">Ensure your brand identity is protected on Kick.</p>
          </div>
        </div>
...
export default KickUsernameClaims;
